       ...
       public MemberRepository()
        {
            ...
            {
                new Member{SocialSecurityNumber=198406232725, FirstName = "Tommy", LastName="Fors", MemberShipPaid = true },
                new Member{SocialSecurityNumber=198502236412, FirstName = "Klara", LastName="Olsson", MemberShipPaid = true },
                new Member{SocialSecurityNumber=199612231213, FirstName = "Kurt", LastName="Larsson", MemberShipPaid = true },
                ...
                new Member{SocialSecurityNumber=193408234418, FirstName = "Tommy", LastName="River", MemberShipPaid = true },
                new Member{SocialSecurityNumber=194301233313, FirstName = "Housame", LastName="Straw", MemberShipPaid = true },
                new Member{SocialSecurityNumber=191205232214, FirstName = "Gregory", LastName="Sophia", MemberShipPaid = true },
                new Member{SocialSecurityNumber=201201232316, FirstName = "Jack", LastName="Klarx", MemberShipPaid = true },
                new Member{SocialSecurityNumber=201302235517, FirstName = "Petra", LastName="Wast", MemberShipPaid = true },
                new Member{SocialSecurityNumber=200303234517, FirstName = "Petra", LastName="Kviverb", MemberShipPaid = true },
                new Member{SocialSecurityNumber=196404234517, FirstName = "Filip", LastName="Flop", MemberShipPaid = true },
                ...
                new Member{SocialSecurityNumber=195707235617, FirstName = "Sailor", LastName="Isglass", MemberShipPaid = true },
                new Member{SocialSecurityNumber=196708235618, FirstName = "Sven", LastName="Hast", MemberShipPaid = true },
                new Member{SocialSecurityNumber=198709237317, FirstName = "Tor", LastName="Kwast", MemberShipPaid = true },
                new Member{SocialSecurityNumber=198901237416, FirstName = "Gunnel", LastName="Flap", MemberShipPaid = true },
            };
        }
    }
}
