       ...
       public MemberRepository()
        {
            Members = new List<Member>
            {
                ...
                new Member{SocialSecurityNumber=201101232316, FirstName = "Jack", LastName="Klarx", MemberShipPaid = false },
                new Member{SocialSecurityNumber=201002235517, FirstName = "Petra", LastName="Fibonacchi", MemberShipPaid = true },
